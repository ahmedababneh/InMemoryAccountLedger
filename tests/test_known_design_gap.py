...
class ReversalDoesNotUnwindConsequentialFees(unittest.TestCase):
    ...
    def test_fees_caused_solely_by_an_entry_that_was_reversed_are_not_refunded(self):
        ...
        self.assertEqual(
            ...
            "    hide the choice; failing here makes someone make it. The\n"
            "    decision has a name -- Policy.reversal_refunds_consequential_fees\n"
            "    -- but no implementation behind it, and setting it True raises\n"
